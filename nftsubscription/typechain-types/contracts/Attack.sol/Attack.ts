...
export interface AttackInterface extends utils.Interface {
  functions: {
    ...
    "bankAccountSmartContractAddress()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "attack"
      | "bankAccountSmartContractAddress"
      | "owner"
      | "renounceOwnership"
      | "transferOwnership"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "bankAccountSmartContractAddress",
    values?: undefined
  ): string;
...
export interface Attack extends BaseContract {
  ...
  bankAccountSmartContractAddress(overrides?: CallOverrides): Promise<string>;
